...
#en JS se utiliza , en pyhton se utiliza la palabra 'and'
#En JS se utiliza || en python se utiliza la palabra or 
#En el and todo tiene que ser verdadero para que sea verdadero
...
verduras2= verduras
verduras3 = ['apio', 'lechuga', 'zapallo'] #['brocoli', 'espinaca','zuchini'] 
#NOTA: Las colecciones de datos son variables mutables (qeu cuando cambio su contenido este se vera reflejado en todas las copias de dicha variable)
...
#Si hablamos de variables primitivas
#  (str,int, float, boolean, date) entonces al 
# hacer la copia compartira mismo espacio de memoria PERO al hacer 
# alguna modificacion a cualquiera de las dos o mas variables que esten 
# usando el mismo espacio de memoria automaticamente python le asignara uno nuevo)
